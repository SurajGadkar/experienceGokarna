          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="w-12 h-12 bg-gradient-to-r from-teal-500 to-blue-500 rounded-2xl flex items-center justify-center">
                    ...
                    >
                      <path
                        ...
                        strokeWidth={2}
                        d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7m6-3v13"
                      />
                    </svg>
                  </div>
                  <div>
            ...
            <div className="space-y-12">
              <div>
                ...
                <div className="divider w-24 bg-gradient-to-r from-teal-500 to-blue-500"></div>
              </div>
              ...
              <div className="pt-8">
                <Link
                  to="/treks"
                  className="btn-primary px-12 py-6 text-xl shadow-2xl inline-flex items-center gap-3"
                >
                  Start Trekking
                  <svg
                    className="w-6 h-6"
